...
def draw(sr, cr, sr1, cr1, width, height):
  nimg = []
  cr.scale(width, height)
  cr.set_source_rgba(1,1,1,1)
  cr.rectangle(0,0,width,height)
  cr.fill()
  cr1.scale(width, height)
...
srf1 = cairo.RecordingSurface(cairo.Content(1), cairo.Rectangle(0.0,0.0,500,500))
ctx1 = cairo.Context(srf1)
nimg = draw(srf, ctx, srf1, ctx1, 500, 500)
#images = nimg
nimg[0].save('test.gif', save_all=True, append_images=nimg[1:], optimize=False, duration=3, loop=1)

srf2 = cairo.ImageSurface(cairo.FORMAT_ARGB32, 500, 500)
...
srf3 = cairo.SVGSurface('test.svg', 500, 500)
