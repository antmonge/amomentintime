...
export default class Marketing extends React.Component {
  ...
  render() {
    return (
      ...
      <img className="MktImg" src={require(`./proto1.gif`).default} alt="Proto1"/>
      ...
      <img className="MktImg" src={require(`./proto2.gif`).default} alt="Proto1"/>
      ...
      <img className="MktImg" src={require(`./proto3.gif`).default} alt="Proto1"/>
      ...
      <div className="PurposeBodyB">
      <img className="MktImg" src={require(`./proto4.gif`).default} alt="Proto1"/>
