...
trirand = argexer
trisize = spectrum(argsensat)
tricol1 = argsmltyp
triopaq = spectrum(argsensat)
...
# Weather 1-5 Sunny-Yellow, Partly Cloudy-Light Yellow, Mostly Cloudy-White, Cloudy-Light Grey, Stormy-Dark Grey
# Temperature 1-5 Hot-Orange, Warm-Light Orange, Cool-Light Green, Crisp-Light Teal, Cold-Light Blue
...
if solid == 1:
  ...
  if col1 == 1:
    ...
    cred1 = color(950, 1000)
    cgreen1 = color(950, 1000)
    cblue1 = color(400, 800)
  elif col1 == 3:
    cred1 = color(800, 950)
    cgreen1 = color(800, 950)
    cblue1 = color(800, 950)
  elif col1 == 4:
    cred1 = color(200, 500)
    cgreen1 = color(200, 500)
    cblue1 = color(200, 500)
  else:
    cred1 = color(500, 800)
    cgreen1 = color(500, 800)
    cblue1 = color(500, 800)

  if col2 == 1:
    cred2 = color(950, 1000)
    cgreen2 = color(400, 800)
    cblue2 = color(0, 200)
  elif col2 == 2:
    cred2 = color(950, 1000)
    cgreen2 = color(700, 900)
    cblue2 = color(400, 800)
  elif col2 == 3:
    cred2 = color(400, 800)
    cgreen2 = color(950, 1000)
    cblue2 = color(400, 800)
  elif col2 == 4:
    cred2 = color(400, 800)
    cgreen2 = color(950, 1000)
    cblue2 = color(700, 900)
  else:
    cred2 = color(400, 800)
    cgreen2 = color(400, 800)
    cblue2 = color(950, 1000)
...
# Taste Strength - Bland, Mild, Seasoned, Flavorful, Intense
# White, Sky Blue, Purple, Brown, Black
...
# Smell Strength - Scentless, Subtle, Scented, Aromatic, Potent
# Light Rose, Teal, Neon Green, Orange, Red
...
# Smell Type - Fragrant, Pleasant, Neutral, Stale, Pungent
# Light Rainbow, Rose, Blue, Grey, Army Green
...
# Taste Type - Mouthwatering, Pleasant, Tasteful, Disagreeable, Repulsive
# Royal Blue, Pink, Light Rainbow, Green, Yellow
