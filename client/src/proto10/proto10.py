...
circquant = spectrum(argintro)
circrand = argsndtyp
circsize = spectrum(argaccept)
circopaq = spectrum(argintro)
circcol1 = argtemper
...
squigquant = spectrum(argpeople)
squigrand = argtststr
squigsize = spectrum(argpeople)
...
# Temper - Bliss, Calmness, Annoyance, Anger, Rage
# Soft Green, Soft Rainbow, Rainbow, Purple, Brown/Green
...
# Taste Type - Mouthwatering, Pleasant, Tasteful, Disagreeable, Repulsive
# Rainbow, Blue, Brown/Green, Orange, Red
